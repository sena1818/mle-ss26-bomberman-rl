...
>
> **击杀是怎么来的，§7.41 已经测清楚**：Rainbow 的击杀 **61% 来自放弹瞬间
> 没有任何对手在射程内的弹**（每 100 颗命中 2.18 次，`R02_9` 只有 0.49 次，
> 4.4 倍），而 `R02_9` 的击杀 57% 来自「看见射程内有人就炸」。
> 缺的从来不是「按下 BOMB 的意愿」——A07 把下手率买到了 15.3%（Rainbow 17.6%）
> 而击杀纹丝不动——**缺的是放在哪、什么时候放。**
