...
| `R02_9_eps0_seed1001_round10000.npz` | `R02_9` | `runs/m3_noisy_10000_vs3rb_20260830/jobs/train_seed1001/agent/latest_model.npz` (Hetzner `bomberman-r01`). The M3 epsilon-0 baseline's submission seed (docs/01 section 7.44): chosen on validation (3.9667), 3.8441 on holdout over 35 repeats, the tightest seed spread on the line. Committed so the tournament proxy pool can measure it beside the other candidates. |
